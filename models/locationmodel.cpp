...
LocationModel::LocationModel
(const QString &latitude, const QString &longitude, const QString &label)
: LocationModel()
{
    latitude_ = latitude;
...
void LocationModel::setLatitude(QString latitude)
{
    auto temp = latitude_;
    latitude_ = latitude;
    if (temp != latitude) emit changed(this);
}
...
void LocationModel::setLongitude(QString longitude)
{
    ...
    longitude_ = longitude;
    if (temp != longitude) emit changed(this);
}
...
void LocationModel::setLabel(QString value)
{
    auto temp = label_;
    label_ = value;
    if (temp != value) emit changed(this);
}
