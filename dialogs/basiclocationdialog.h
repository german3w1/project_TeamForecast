...
class BasicLocationDialog : public RoundedDialog
{
...
protected:
    ...
    */
    BasicLocationDialog(QWidget *parent, QWidget *dimmable_widget = nullptr);
    virtual ~BasicLocationDialog();
    TextWidget *title; ///< Dialog title label
    ...
    AnimatedButton* ok_btn; ///< Button allowing to add/save location
private:
