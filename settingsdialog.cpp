...
SettingsDialog::SettingsDialog(QWidget *parent) : QDialog(parent, Qt::FramelessWindowHint)
{
    ...
    auto title = new QLabel("Настройки");
    ...
    auto ok_btn = new QPushButton("Сохранить");
    ...
    main_layout->addWidget(title, 0, 0, 1, 4);
