    ...
    : AnimatedWidget(parent)
{
    ...
    temp_value_ = new QLabel(model_->current().temperature("temperature") + "/" +
                             model_->current().temperature("reelfeel"));
...
void LocationMiniView::contentUpdated()
{
    ...
    temp_value_->setText(model_->current().temperature("temperature") + "/" +
                         model_->current().temperature("reelfeel"));
}
